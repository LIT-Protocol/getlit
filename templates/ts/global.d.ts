declare global {
  ...
  var LitActions: {
     ...
     */
    isPermittedAction(params: { tokenId: string; ipfsId: string }): boolean;
     ...
     */
    isPermittedAddress(params: { tokenId: string; address: string }): boolean;
     ...
     */
    getPermittedAuthMethods(params: { tokenId: string }): object[];
     ...
     * @returns The token ID as a string
     */
    getLatestNonce(params: { address: string; chain: string }): string;
